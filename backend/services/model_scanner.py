...
_CP_KIND_MAP: dict[ModelCheckpointID, tuple[ArtifactKind, str]] = {
    ...
    "ltx-2.3-22b-distilled-fp8-kijai-v3": ("diffusion_model", "base_diffusion_model_fp8"),
    "ltx-2.3-22b-distilled-gguf-quantstack-q2-k": ("gguf", "base_diffusion_model_gguf"),
    "ltx-2.3-22b-distilled-gguf-quantstack-q3-k-s": ("gguf", "base_diffusion_model_gguf"),
    "ltx-2.3-22b-distilled-gguf-quantstack-q3-k-m": ("gguf", "base_diffusion_model_gguf"),
    "ltx-2.3-22b-distilled-gguf-quantstack-q4-k-s": ("gguf", "base_diffusion_model_gguf"),
    "ltx-2.3-22b-distilled-gguf-quantstack-q4-k-m": ("gguf", "base_diffusion_model_gguf"),
    "ltx-2.3-22b-distilled-gguf-quantstack-q5-k-s": ("gguf", "base_diffusion_model_gguf"),
    "ltx-2.3-22b-distilled-gguf-quantstack-q5-k-m": ("gguf", "base_diffusion_model_gguf"),
    "ltx-2.3-22b-dev": ("diffusion_model", "base_diffusion_model"),
}
...
_EXTRA_KNOWN_ARTIFACTS: list[_CanonicalArtifact] = [
    _CanonicalArtifact(
        ...
        is_folder=False,
        gated=False,
        cp_id="ltx-2.3-text-projection-bf16",
        adapter_id=None,
        section="kijai",
