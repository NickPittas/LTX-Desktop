...
class FastVideoPipeline(Protocol):
    ...
    def create(
        ...
        *,
        ...
        # Phase 2: memory plan owns the offload/quantization decision. Defaults
        # to None as a narrow compatibility shim until the handler slice passes
        # explicit plans; when provided, its offload_mode is trusted exactly.
